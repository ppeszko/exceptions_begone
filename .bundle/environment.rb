...
module Bundler
  LOCKED_BY    = '0.9.9'
  FINGERPRINT  = "d6b4583520932ab183f5de9d781ae3d0ad7438a8"
  AUTOREQUIRES = {:test=>[["redgreen", false], ["cucumber", false]], :default=>[["mislav-will_paginate", false], ["authlogic", false], ["haml", false], ["ruby-net-ldap", false], ["lukeredpath-simpleconfig", false]], :development=>[["josevalim-rails-footnotes", false]], :cucumber=>[["thoughtbot-factory_girl", false], ["cucumber-rails", false], ["webrat", false], ["database_cleaner", false], ["rspec", false], ["rspec-rails", false]]}
  SPECS        = [
        ...
        {:loaded_from=>"/Library/Ruby/Gems/1.8/specifications/rack-1.1.0.gemspec", :load_paths=>["/Library/Ruby/Gems/1.8/gems/rack-1.1.0/lib"]},
        ...
        {:loaded_from=>"/Library/Ruby/Gems/1.8/specifications/haml-2.2.20.gemspec", :load_paths=>["/Library/Ruby/Gems/1.8/gems/haml-2.2.20/lib"]},
