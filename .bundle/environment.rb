...
module Bundler
  LOCKED_BY    = '0.9.9'
  FINGERPRINT  = "6f214c981c1e6b55ee45564e4e3e2f832ae74fcf"
  AUTOREQUIRES = {:test=>[["factory_girl", true], ["redgreen", false]], :default=>[["mongodb-mongo", false], ["jnunemaker-validatable", false], ["mongo_mapper", true], ["will_paginate", true], ["authlogic", false], ["net/ldap", true], ["simpleconfig", true]], :development=>[["rails-footnotes", true]], :cucumber=>[["cucumber-rails", false], ["database_cleaner", false]]}
  SPECS        = [
